...
var _frzr = require('frzr');

var _frzr2 = _interopRequireDefault(_frzr);
...
// define <p> component
var P = _frzr2.default.View.extend({
  el: 'p',
...
var Option = _frzr2.default.View.extend({
  el: 'option',
  update: function update(data) {
...
var Select = _frzr2.default.View.extend({
  el: 'select',
  init: function init() {
    // create ViewList for options
    this.options = new _frzr2.default.ViewList({
      View: Option
    });
    // add 'change' listener
...
// wrap <body>
var body = new _frzr2.default.View({
  el: document.body
});
...
},{"frzr":2}],2:[function(require,module,exports){
(function (global){
'use strict';
